...
|------|-------------------|
| running the 8 DX passes, required outputs, and review report (only after Step 0 investigation is complete) | `sections/gstack-review-sections.md` |
---
...
> **STOP.** Before running the 8 DX passes, required outputs, and review report (only after Step 0 investigation is complete), Read `.github/skills/plan-devex-review/sections/gstack-review-sections.md` and execute it
...
Confirm you Read the review section the Section index named, and executed all 8 DX passes, the required outputs, and the review report in full. If you produced findings or the review report from memory without Reading `sections/gstack-review-sections.md`, stop and Read it now.
