...
* **Zero findings:** if a section has zero findings, state "No issues, moving on"
  and proceed. Otherwise, use ask_user for each gap — a gap with an
...
finding above. Run with Claude Code or Outside Voice; checkbox as you ship.
...
- Effort uses the AI-compression table from copilot-instructions.md.
