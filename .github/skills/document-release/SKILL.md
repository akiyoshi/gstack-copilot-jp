...
.github/skills/bin/gstack-redact --from-file /tmp/gstack-pr-body-$$.md --repo-visibility "${REDACT_VIS:-unknown}" --json
...
```bash
NEW_TITLE=$(.github/skills/bin/gstack-pr-title-rewrite.sh "$V" "$CURRENT_TITLE")
```
